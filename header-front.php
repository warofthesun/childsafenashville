		...
		<div id="container">
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="inner-header" class="wrap flex flex--row flex--row_collapse">
					...
					<p id="logo" class="h1 col-xs-12 col-md-8" itemscope itemtype="http://schema.org/Organization"><a href="<?php echo home_url(); ?>" rel="nofollow"><?php bloginfo('name'); ?></a></p>

					<?php // if you'd like to use the site description you can un-comment it below ?>
					<?php // bloginfo('description'); ?>


					<nav role="navigation" class="col-xs-12 col-md-4 nav--header" itemscope itemtype="http://schema.org/SiteNavigationElement">
